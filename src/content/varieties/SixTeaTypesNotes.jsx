    ...
    return (
      <div className="space-y-12 animate-fadeIn">
        ...
        <div className="bg-white rounded-3xl border border-stone-200 p-8 md:p-12 shadow-sm">
          ...
          <div className="prose prose-stone prose-lg max-w-none text-stone-700 leading-relaxed space-y-8">
            <section className="space-y-3">
              <div className="text-[17px] font-extrabold text-stone-900">1. 中國茶的六大分類：以發酵定義茶之本質</div>
              <p>
            ...
            <section className="space-y-3">
              <div className="text-[17px] font-extrabold text-stone-900">2. 綠茶的悠久起源：從神話到信史</div>
              <p>
              ...
              <div className="grid md:grid-cols-3 gap-6 not-prose">
                ...
                <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 space-y-3">
                  ...
                  <ol className="list-decimal pl-5 space-y-1 text-[17px]">
            ...
            <section className="space-y-4">
              <div className="text-[17px] font-extrabold text-stone-900">3. 飲茶風尚的演變：一部跨越朝代的文化史</div>
              <p>
              ...
              <div className="rounded-2xl border border-stone-200 bg-stone-50/50 px-6 py-5 space-y-3">
                <div className="font-extrabold text-stone-900 text-[19px]">3.1 秦漢至魏晉南北朝：從宮廷飲品到文化符號</div>
                <p>
              ...
              <div className="rounded-2xl border border-stone-200 bg-stone-50/50 px-6 py-5 space-y-3">
                <div className="font-extrabold text-stone-900 text-[19px]">3.2 唐代：茶聖陸羽與「煎茶」的確立</div>
                <p>
              ...
              <div className="rounded-2xl border border-stone-200 bg-stone-50/50 px-6 py-5 space-y-3">
                <div className="font-extrabold text-stone-900 text-[19px]">3.3 宋代：登峰造極的「點茶」與「鬥茶」文化</div>
                <p>
              ...
              <div className="rounded-2xl border border-stone-200 bg-stone-50/50 px-6 py-5 space-y-3">
                <div className="font-extrabold text-stone-900 text-[19px]">3.4 明代：返璞歸真的「泡茶」時代</div>
                <p>
            ...
            <section className="space-y-4">
              <div className="text-[17px] font-extrabold text-stone-900">4. 現代綠茶品飲實用指南</div>

              <div className="not-prose grid md:grid-cols-2 gap-6">
                <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 space-y-3">
                  <div className="font-extrabold text-stone-900">4.1 知名綠茶品類鑑賞</div>
                  <p className="text-[17px]">中國綠茶品類繁多，各具特色。以下是一些廣受讚譽的代表性名茶：</p>
                ...
                <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 space-y-3">
                  ...
                  <p className="text-[17px]">想要泡好一杯綠茶，需要掌握器皿選擇與沖泡技巧的要點。</p>
                  <p className="text-[17px]">
                    器皿選擇 建議使用玻璃杯或白瓷蓋碗。因為綠茶未經發酵，保留了鮮葉的翠綠色澤與完整形態，使用透明或淺色的器皿，便於在沖泡過程中欣賞茶葉舒展的美態與清澈的湯色。
                  </p>
                  <p className="font-extrabold text-stone-900 text-base">沖泡兩大關鍵</p>
                  <ol className="list-decimal pl-5 space-y-1 text-[17px]">
                    <li>水溫：80°C 左右。綠茶多為鮮嫩的芽頭，絕對不能使用沸水沖泡，過高的溫度會將其「燙壞」，破壞其鮮爽的口感與營養成分。</li>
                    <li>不加蓋。沖泡過程中不要蓋上蓋子，否則會將茶葉「悶黃」，使其失去鮮綠的色澤和清新的香氣。</li>
                  </ol>
                  <p className="font-extrabold text-stone-900 text-[17px]">「三明治泡法」步驟詳解 這是一種能充分展現綠茶風味的實用泡法：</p>
                  <ol className="list-decimal pl-5 space-y-1 text-[17px]">
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6">
                <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 space-y-3">
                  ...
                  <p className="font-extrabold text-stone-900 text-base">飲用提醒</p>
                  <ul className="list-disc pl-5 space-y-1 text-[17px]">
                ...
                <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 space-y-3">
                  ...
                  <p className="text-[17px]">在選購高品質綠茶時，您常會遇到兩個術語：「明前茶」和「雨前茶」。</p>
                  <ul className="list-disc pl-5 space-y-1 text-[17px]">
                    <li>明前茶：指在清明節氣之前採摘和製作的茶葉。</li>
                    <li>雨前茶：指在穀雨節氣之前、清明之後採摘和製作的茶葉。</li>
                  </ul>
                  <p className="text-[17px]">兩者對比</p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 bg-gradient-to-br from-stone-50 to-white rounded-3xl p-8 border border-stone-200 overflow-hidden">
          ...
          <div className="space-y-6">
            <div>
              <div className="text-sm font-extrabold tracking-[0.28em] text-emerald-600">SPECIAL FEATURE</div>
              ...
              <div className="flex gap-2 mt-4 flex-wrap">
                {['洞庭山', '驚蟄雨前', '滿披白毫', '上投法', '嚇煞人香'].map((tag) => (
                  <span key={tag} className="rounded-full border border-emerald-200 bg-white px-3 py-1 text-sm text-emerald-900 font-bold">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-stone-100 rounded-2xl p-5">
              ...
              <ol className="list-decimal pl-5 text-[17px] text-stone-700 space-y-1">
          ...
          <div className="space-y-6">
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg border border-stone-100 group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/60 to-transparent flex items-end p-6">
                <div className="text-white text-base font-bold bg-black/30 px-3 py-1 rounded-full backdrop-blur-sm border border-white/20">
                  欣賞茶芽在水中舒展的「茶舞」
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-stone-200 p-5">
              <div className="text-sm font-extrabold tracking-widest text-emerald-600 mb-2">四時養生</div>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-2">
                  <Sprout size={16} className="text-emerald-500" />
                  <div>
                    <div className="font-bold text-stone-900 text-base">春飲綠茶</div>
                    <div className="text-sm text-stone-500">疏肝理氣，清解春燥</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 opacity-60">
                  <div className="w-4 h-4 rounded-full border border-stone-300" />
                  <div>
                    <div className="font-bold text-stone-900 text-base">冬飲熟茶</div>
                    <div className="text-sm text-stone-500">溫養與安定</div>
                  </div>
                </div>
              </div>
            </div>
