...
function BulletList({ items }) {
  return (
    <ul className="space-y-2 text-base leading-7 text-stone-800">
      {items.map((line) => (
            ...
            {showSection('cc-1') ? (
              <Section id="cc-1" title="1、茶葉命名" scrollMarginTop={resolvedTopOffsetPx}>
                ...
                <div className="rounded-2xl border border-stone-200 bg-white/65 p-4 md:p-5">
                  ...
                  <div className="mt-3 text-base leading-6 text-stone-600">你可以把茶名想成「多維度標籤」的組合，而不是單一分類。</div>
                </div>
            ...
            {showSection('cc-2') ? (
              <Section id="cc-2" title="2、茶葉分類依據" scrollMarginTop={resolvedTopOffsetPx}>
                ...
                <div className="rounded-2xl border border-stone-200 bg-white/65 p-4 md:p-5">
                  ...
                  <div className="mt-3 text-base leading-6 text-stone-600">陳椽主張：分類要能「對應到工藝差異」，並能服務教學與實務使用。</div>
                </div>
