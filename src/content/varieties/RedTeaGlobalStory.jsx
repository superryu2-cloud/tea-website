    ...
    <div className="space-y-12 animate-fadeIn text-stone-800">
      ...
      <div className="rounded-[3rem] overflow-hidden bg-[#1c1917] text-stone-200 shadow-2xl relative">
        ...
        <div className="relative z-10 p-10 md:p-16 space-y-16">
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-stone-400 max-w-3xl mx-auto text-[19px] leading-relaxed font-light">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative rounded-3xl overflow-hidden bg-stone-800/50 border border-stone-700/50 hover:border-rose-900/50 transition-all duration-500 hover:shadow-2xl hover:shadow-rose-900/10">
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-20">
                  <span className="px-3 py-1 bg-rose-900/90 text-rose-100 text-sm font-bold rounded-full backdrop-blur-sm border border-rose-700/50">發源地</span>
                </div>
              </div>
              <div className="p-8 space-y-4">
                <div>
                  <h4 className="text-2xl font-bold text-white mb-1">中國・武夷山</h4>
                  <span className="text-stone-500 text-base font-medium tracking-wider">Wuyi Mountains</span>
                </div>
                <p className="text-stone-400 leading-relaxed text-[17px]">
                  紅茶的誕生地。以「正山小種」聞名，帶有獨特的松煙香與桂圓味，是開啟全球紅茶歷史的起點。
                </p>
                <div className="pt-4 border-t border-stone-700/50 flex items-center gap-2 text-rose-400 text-sm">
                  <Mountain size={14} />
                  <span>福建省崇安縣</span>
                </div>
              </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden bg-stone-800/50 border border-stone-700/50 hover:border-amber-900/50 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-900/10">
              ...
              >
                ...
                />
                <div className="absolute top-4 right-4 z-20">
                  <span className="px-3 py-1 bg-amber-700/90 text-amber-100 text-sm font-bold rounded-full backdrop-blur-sm border border-amber-500/50">最大產區</span>
                </div>
              </div>
              <div className="p-8 space-y-4">
                <div>
                  <h4 className="text-2xl font-bold text-white mb-1">印度・阿薩姆</h4>
                  <span className="text-stone-500 text-base font-medium tracking-wider">Assam</span>
                </div>
                <p className="text-stone-400 leading-relaxed text-[17px]">
                  位於喜馬拉雅山南麓。茶湯濃烈、色澤深紅，帶有濃郁麥芽香，是英式早餐茶的主要基底，適合調製奶茶。
                </p>
                <div className="pt-4 border-t border-stone-700/50 flex items-center gap-2 text-amber-500 text-sm">
                  <Globe size={14} />
                  <span>印度東北部</span>
                </div>
              </div>
            ...
            <div className="group relative rounded-3xl overflow-hidden bg-stone-800/50 border border-stone-700/50 hover:border-blue-900/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-900/10">
              ...
              >
                ...
                />
                <div className="absolute top-4 right-4 z-20">
                  <span className="px-3 py-1 bg-blue-900/90 text-blue-100 text-sm font-bold rounded-full backdrop-blur-sm border border-blue-700/50">高地茶</span>
                </div>
              </div>
              <div className="p-8 space-y-4">
                <div>
                  <h4 className="text-2xl font-bold text-white mb-1">斯里蘭卡・錫蘭</h4>
                  <span className="text-stone-500 text-base font-medium tracking-wider">Ceylon (Sri Lanka)</span>
                </div>
                <p className="text-stone-400 leading-relaxed text-[17px]">
                  受季風影響，風味清新爽口。烏瓦 (Uva) 產區帶有獨特的鈴蘭花香與薄荷涼氣，被譽為世界三大高香紅茶之一。
                </p>
                <div className="pt-4 border-t border-stone-700/50 flex items-center gap-2 text-blue-400 text-sm">
                  <Mountain size={14} />
                  <span>斯里蘭卡中央山脈</span>
                </div>
              </div>
            ...
            <div className="relative z-10 p-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left pointer-events-none">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-[17px] mt-1">以麝香葡萄風味著稱，產量稀少且珍貴。</p>
                </div>
              </div>
              <div className="hidden md:block">
                <span className="px-4 py-2 border border-stone-600 rounded-lg text-stone-400 text-base tracking-widest hover:bg-stone-800 transition-colors cursor-default">PREMIUM</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border border-stone-200">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed">
          <div>
            <h5 className="font-bold text-[19px] text-stone-900 mb-2">1. 波士頓傾茶事件 (1773)</h5>
            <p>
              為了幫東印度公司銷庫存，英國通過《茶稅法》。憤怒的北美茶商將342箱中國茶（多為武夷紅茶）倒入海中。這直接引發了<strong>美國獨立戰爭</strong>。
              <span className="text-[17px] text-stone-500 block mt-1">*1973年美國郵政局還發行了一套四枚郵票紀念此場景。</span>
            </p>
          </div>
          <div>
            <h5 className="font-bold text-[19px] text-stone-900 mb-2">2. 鴉片戰爭 (1840)</h5>
            <p>
