...
export default function TeaEncyclopediaOverview() {
    return (
        <div className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="rounded-2xl border border-green-200 bg-green-50 p-6">
                                <div className="flex items-center mb-3">
                                    ...
                                    <div className="text-base font-extrabold text-green-900">單芽</div>
                                </div>
                            ...
                            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
                                <div className="flex items-center mb-3">
                                    ...
                                    <div className="text-base font-extrabold text-amber-900">一芽一葉 / 一芽二葉</div>
                                </div>
                                <p className="text-[17px] text-stone-700 leading-relaxed">
                            ...
                            <div className="rounded-2xl border border-stone-300 bg-stone-50 p-6">
                                <div className="flex items-center mb-3">
                                    ...
                                    <div className="text-base font-extrabold text-stone-900">一芽三四葉</div>
                                </div>
                                <p className="text-[17px] text-stone-700 leading-relaxed">
            ...
            {/* Flavor Formation */}
            <div className="rounded-3xl border border-stone-200 bg-white px-8 py-10">
                <div className="text-sm font-extrabold tracking-[0.28em] text-stone-500 mb-4">FLAVOR MAP</div>
            ...
            <div className="rounded-3xl border border-stone-200 bg-gradient-to-br from-stone-50 to-amber-50 px-8 py-10">
                <div className="text-sm font-extrabold tracking-[0.28em] text-stone-500 mb-4">REFLECTION</div>
            ...
            <div className="rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-100 to-green-100 px-8 py-12 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    <div className="rounded-2xl border border-green-200 bg-white p-6">
                        <div className="text-[19px] font-extrabold text-green-800 mb-2">喜歡清淡</div>
                        <p className="text-[17px] text-stone-600">從綠茶、白茶出發</p>
                    </div>
                    <div className="rounded-2xl border border-amber-200 bg-white p-6">
                        <div className="text-[19px] font-extrabold text-amber-800 mb-2">口味較重</div>
                        <p className="text-[17px] text-stone-600">從烏龍茶、紅茶開始</p>
                    </div>
                    <div className="rounded-2xl border border-stone-300 bg-white p-6">
                        <div className="text-[19px] font-extrabold text-stone-800 mb-2">喜歡沉穩木質調</div>
                        <p className="text-[17px] text-stone-600">從黑茶開始選擇</p>
                    </div>
                </div>
            </div>
        </div>
