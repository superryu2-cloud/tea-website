...
function SubsectionTitle({ id, title }) {
  return (
    <h4 id={id} className="scroll-mt-28 text-[19px] md:text-[22px] font-extrabold font-sans text-stone-900">
      {title}
    </h4>
  );
}
...
function BulletList({ children }) {
  return <ul className="mt-3 space-y-2 text-[17px] leading-relaxed font-sans text-stone-700 list-disc pl-5">{children}</ul>;
}
  ...
  return (
    <article className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
      <header className="px-6 py-6 md:px-10 md:py-9 border-b border-stone-200 bg-gradient-to-br from-sky-50 via-white to-emerald-50">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <h3 className="mt-3 text-[24px] md:text-4xl font-extrabold font-sans text-stone-900 leading-tight">
              一心二葉知多少：茶葉栽培、採摘與風味解析——專家解析報告
            </h3>
            <p className="mt-3 text-[17px] leading-relaxed font-sans text-stone-600">茶業改良場前場長 陳國任博士</p>
          </div>
        </div>
      </header>
      ...
      <div className="px-6 py-8 md:px-10 md:py-10 space-y-10">
        ...
        <div className="my-8">
          <ClickableImage
            src="/images/tea-talk/picking/tea_picking_scene.png"
            alt="傳統採茶場景"
            caption="傳統採茶場景：茶農在梯田茶園中細心採摘嫩葉，晨霧繚繞，陽光灑落"
            className="w-full"
          />
        </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-[17px] leading-relaxed font-sans text-stone-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-2xl border border-stone-200 bg-white p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <div className="text-[19px] font-extrabold font-sans text-stone-900">1）氣候條件</div>
                  <BulletList>
                    <li>
            ...
            <div className="rounded-2xl border border-stone-200 bg-white p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <div className="text-[19px] font-extrabold font-sans text-stone-900">2）土壤條件</div>
                  <BulletList>
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-2xl border border-stone-200 bg-stone-50 p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <div className="text-[19px] font-extrabold font-sans text-stone-900">採摘成熟度（依製茶類型）</div>
                <BulletList>
                  <li>
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <div className="text-[19px] font-extrabold font-sans text-stone-900">「嫩採」與「採嫩」</div>
            <BulletList>
              <li>
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <div className="text-[19px] font-extrabold font-sans text-stone-900">嫩葉 vs 老茶（概念）</div>
            <BulletList>
              <li>
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-2xl border border-stone-200 bg-stone-50 p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <div className="text-[19px] font-extrabold font-sans text-stone-900">灌溉原則（摘要）</div>
                <BulletList>
