    ...
    return (
        <Section id="zisha-5" title="5．文人點化：紫砂壺的雅士之情" icon={BookOpen}>
            ...
            <SubCard title="從器具到載體：文人壺的誕生">
                ...
                {/* 引文高亮區塊 */}
                <blockquote className="mt-4 pl-5 border-l-4 border-amber-400 bg-amber-50/40 py-3 pr-4 rounded-r-xl italic text-stone-700">
                    「野隱幾庭，文明可居」——以壺養性，以器載道
                </blockquote>
