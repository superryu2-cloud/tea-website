...
const ESSAY_DATA = [
    ...
    },
    {
        ...
        craftsmanship: '這款茶的工藝核心是「中度發酵與中度烘焙」。發酵度約在 20-30%。在進行完殺青與著名的「布球揉捻（團揉）」工藝後，反覆揉捻成緊實的半球形。這種重烘焙的傳統工藝，能徹底昇華茶葉風味，呈現出迷人的焦糖與烘烤香。',
        toolsAndBrew: '品茗凍頂烏龍，紫砂壺或陶壺是絕配，其溫潤的氣孔結構最能展現焙火茶的渾厚喉韻。沖泡水溫建議使用 90 到 95 度的熱水。因為是紮實的半球型，第一泡建議進行快速的「溫潤泡」醒茶，以利葉片舒展。首泡約悶 50 秒即可出湯，品味那深沉甘潤、耐泡度極佳的經典凍頂氣。'
    },
    {
        id: 5,
        title: '台灣鐵觀音',
