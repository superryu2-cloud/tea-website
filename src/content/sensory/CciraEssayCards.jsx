...
const ESSAY_DATA = [
    {
        ...
        features: '色：乾茶細嫩捲曲如螺，白毫明顯，茶湯多呈淡黃綠或青綠色，不是日本蒸青綠茶那種鮮翠綠。香：以青香、嫩豆香、綠豆香、豆漿香、玉米筍般的新鮮蔬菜香為主，花香與甜香較輕。味：入口清、嫩、活，鮮爽沁心，喝的是春芽的清新感，不是濃厚取勝。',
    ...
    },
    {
        ...
        features: '色：乾茶呈自然彎曲的條索狀，色澤墨綠或翠綠，茶湯蜜綠顯黃。香：以清雅花香為主，常有茉莉、蘭花、梔子、百合般的細膩香氣。味：滋味甘醇、鮮活、純淨，香氣入水，像「荳蔻少女」一樣清新細緻。',
    ...
    },
    {
        ...
        features: '色：乾茶多為緊結半球形或球形，色澤翠綠鮮活，茶湯金黃、蜜綠或蜜黃色。香：以花香與甜香為主，帶高山冷冽香與山頭氣。味：滋味甘醇滑軟，果膠質感明顯，苦澀低，喉間有清涼回甘。',
    ...
    },
    {
        ...
        features: '色：乾茶緊結成半球形或球形，顆粒圓潤，色澤墨綠或帶焙火後的深褐綠，茶湯橙黃到琥珀色。香：有熟果香、焙米香、焦糖香、堅果香與舒服焙火香。味：滋味醇厚圓潤，口腔飽滿度高，喉韻與回甘明顯。',
    ...
    },
    {
        ...
        features: '色：乾茶多為半球形或球形，色澤較深，常偏墨綠、鐵黑或深褐，茶湯橙黃到琥珀色。香：香氣沉穩，有重焙火香、成熟果酸香、品種香、木質調，有時聞香可感到微弱鐵鏽感或特殊觀音韻。味：茶湯溫潤甘醇，收斂性較強，帶微酸再轉甘，層次深，重點是喉間回來的觀音韻。',
    ...
    },
    {
        ...
        features: '色：乾茶呈條型五色茶乾，白、綠、黃、紅、褐相間，白毫極顯著，茶湯明亮琥珀或橙紅。香：同時有蜜香、熟果香與淡雅花香。味：滋味甜和圓潤，不苦不澀，帶天然蜜糖甜感，細緻而有辨識度。',
    ...
    },
    {
        ...
        features: '色：乾茶揉捻成緊結球形，色澤墨紅或烏黑油潤，茶湯像紅茶般明亮琥珀橙紅或紅艷。香：有焙香、熟果香、焦糖甜香，也帶紅茶般甘甜果韻。味：滋味醇厚飽滿，果膠質感強，熱泡厚實，冷泡也甜潤討喜。',
    ...
    },
    {
        ...
        features: '色：乾茶多為條索狀，茶湯紅艷清澈、明亮有光。香：大葉種如紅玉常有肉桂香、薄荷香與熟果香；小葉種紅茶則常有熟果香、蜜香與甜香。味：大葉種滋味強勁飽滿，小葉種較溫和柔順，兩者都應有甜潤感與回甘。',
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-6 animate-in slide-in-from-bottom-4 duration-500 pb-16">
            <div className="text-center space-y-3 mb-10 mt-4">
                ...
                <p className="text-stone-600 font-medium text-lg">每款茶皆依固定順序整理：色、香、味，接著說明特色成因、產地環境、歷史與名稱由來、沖泡器具與參數，方便抽到題目後照順序上台說明。</p>
            </div>
                            ...
                            >
                                <div className="overflow-hidden">
                                    <div className="border-t border-stone-100 bg-stone-50/50 p-5 md:p-6 space-y-5">
                                        ...
                                        <PointSection
                                            icon={Coffee}
                                            title={item.id >= 9 ? "5. 泡茶心法與總結" : "5. 沖泡參數：器具、材質、水溫、茶量、時間"}
