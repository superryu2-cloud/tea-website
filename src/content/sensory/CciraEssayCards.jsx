...
const ESSAY_DATA = [
    {
        ...
        features: '碧螺春喝起來最重要的是清、嫩、鮮。考題口徑可記：外觀條形、色澤綠色，茶湯以綠色系為主。入口很乾淨，帶青香、蔬果香、嫩豆香、綠豆香或玉米筍般的新鮮蔬菜香；滋味不是濃厚型，而是像春天嫩芽一樣鮮爽、沁心、有活性。',
    ...
    },
    {
        ...
        features: '文山包種茶喝起來重點是清香與優雅。考題口徑可記：外觀條形、色澤墨綠，茶湯以蜜綠色為代表。香氣以花香為主，常讓人聯想到茉莉、蘭花、梔子或百合；入口甘醇、鮮活、純淨，好的包種茶會有香氣入水，像「荳蔻少女」一樣清新細緻。',
    ...
    },
    {
        ...
        features: '高山茶喝起來是清、香、甘、活。考題口徑可記：外觀多為半球形或球形，茶湯以蜜黃色為代表。香氣以花香、甜香與高山冷冽感為主；入口滑軟甘醇，果膠質感明顯，苦澀低，喝完喉間有清涼回甘與山韻。',
    ...
    },
    {
        ...
        features: '凍頂烏龍喝起來是醇厚、圓潤、有喉韻。考題口徑可記：外觀多為半球形或球形，茶湯以金黃色為代表，主要特色香氣是焙火香。香氣可帶熟果香、焙米香、焦糖香與堅果調；入口比清香型高山茶更厚，口腔飽滿，回甘與喉韻明顯。',
    ...
    },
    {
        ...
        features: '鐵觀音喝起來重點是韻深。考題口徑可記：外觀多為半球形或球形，茶湯以琥珀色為代表，主要特色香氣是焙火香。香氣沉穩，可有成熟果酸香、木質調與特殊觀音韻；入口溫潤甘醇，收斂性較強，會有微酸再轉甘的層次，重點不是香氣衝，而是喉間慢慢回來的韻。',
    ...
    },
    {
        ...
        features: '東方美人喝起來最迷人的是蜜香與甜潤。考題口徑可記：茶湯呈橙黃到橙紅色，主要特色香氣是蜜香。香氣也常帶熟果香與淡雅花香；入口甜和圓潤，不苦不澀，有天然蜜糖般的甜感，細緻又很有辨識度。',
    ...
    },
    {
        ...
        features: '台灣紅茶喝起來不只是濃，而是有清楚的品種香。考題口徑可記：紅茶屬全發酵茶，外觀色澤可偏黑色，茶湯以紅色為代表。大葉種如紅玉常有肉桂香、薄荷香與熟果香，滋味強勁飽滿；小葉種紅茶則多熟果香、蜜香與甜香，口感較溫和柔順，回甘明顯。',
