...
const SPEECH_SCRIPTS = {
    ...
    2: [
        '文山包種茶，我會用一個字記住它：香。它是台灣清香型條形烏龍的代表，茶乾自然彎曲、色澤墨綠，茶湯以蜜綠色最有代表性。入口清雅、甘醇、乾淨，香氣像茉莉、蘭花、梔子或百合，不是濃豔，而是細緻地浮在茶湯裡。',
        '這種花香來自極輕發酵與不焙火。茶菁經過日光萎凋、室內萎凋與輕微攪拌，讓葉緣剛好轉化出花香；發酵太輕會青，太重又會失去清雅，所以文山包種最難的地方，是把香氣做到成熟但不厚重。',
        '它的代表產區在台北文山、南港，以及新北坪林、石碇、新店、深坑一帶。包種的名稱，和早期用紙包茶的販售形式有關；後來北台灣製茶前輩如魏靜時、王水錦等人，推動不用花薰、靠茶葉本身工藝做出天然花香，形成今天文山包種清香細緻的風格。',
        '沖泡上，我會選白瓷蓋碗或瓷壺，水溫 85 到 90 度。條形茶較蓬鬆，茶量約壺容量四分之一到三分之一，第一泡 45 到 60 秒。最後我會這樣收：文山包種茶的美，不是張揚，而是清香細緻；一杯好的包種茶，像北台灣山霧裡開出的花，淡雅卻很有記憶點。'
    ],
    3: [
