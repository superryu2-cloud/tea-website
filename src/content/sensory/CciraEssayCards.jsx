...
const SPEECH_SCRIPTS = {
    1: [
        "台灣碧螺春，是台灣特色綠茶中很有代表性的一款。它屬於不發酵茶，重點不是厚重，也不是焙火，而是把春天嫩芽最鮮、最青、最乾淨的氣息保留下來。從外觀來看，台灣碧螺春屬於條形茶，茶乾色澤以綠色為主，帶有細嫩芽葉的白毫感；茶湯則以清亮的綠色作為典型表現。",
        "它的風味可以先從香氣記起：主軸是蔬果香、嫩葉香，有時會讓人聯想到玉米筍、嫩豆、豆香或剛採下的新鮮青草氣息。入口時茶湯清亮、輕盈、鮮爽，甜感不會非常厚，但很乾淨，喝完口腔會有清甜回甘與生津感。這款茶最迷人的地方，就是它把新鮮感表現得很直接。",
        "這種特色來自它的製程。碧螺春採摘春天較嫩的芽葉，茶菁進廠後不經過烏龍茶那種靜置、攪拌與發酵，而是盡快殺菁，讓酵素活性停止，避免茶多酚繼續氧化。也因為氧化程度低，所以茶葉能保留較多青綠色澤、鮮爽感與嫩香。簡單說，碧螺春喝的是春茶嫩芽本身的鮮活。",
        "台灣碧螺春最具代表性的產區是新北市三峽。三峽茶區常使用青心柑仔製作，形成與中國洞庭碧螺春不同的台灣風味。名稱上雖有碧螺春的意象，也帶有春茶、細嫩、捲曲如螺的概念，但台灣碧螺春真正的重點，是三峽風土、青心柑仔品種與台灣綠茶工藝所形成的清新風格。",
        "擇器與泡法上，建議使用玻璃杯、白瓷蓋碗或白瓷杯。玻璃器可以觀察茶芽舒展，白瓷器則能忠實呈現茶湯顏色與細緻香氣。水溫約 75 到 80 度，茶菁越嫩，水溫越要溫和；不建議溫潤泡，因為第一泡正是它最鮮的一泡。第二沖之後可以沿杯壁緩慢注水，避免直接衝擊嫩葉，減少苦澀。台灣碧螺春可以這樣總結：它是一杯把春天定格下來的茶，清亮、鮮爽、乾淨。"
    ],
    2: [
        "文山包種茶，是台灣清香型青茶的重要代表。它屬於輕度發酵的部分發酵茶，外觀為條形，茶乾自然彎曲，色澤以墨綠為典型；茶湯則以蜜綠色為標準表現。它不像焙火茶強調厚度，而是以清香、花香、甘醇與細緻感取勝。",
        "品飲文山包種茶時，最先要抓住的是香氣。好的文山包種，香氣清揚而細膩，常見茉莉、蘭花、玉蘭、梔子或野薑花般的花香。茶湯入口甘醇、清爽，口感不厚重，但很乾淨、有層次。它的美感像是一種含蓄的優雅，不是濃烈外放，而是在鼻腔與喉間慢慢展開。",
        "它的特色主要來自輕發酵與不焙火或極輕焙火的製作方向。茶菁經過日光萎凋、室內靜置與攪拌，讓葉片走水、轉香，再透過殺菁固定香氣。文山包種的難度在於發酵程度要拿捏得很細：發酵不足容易青澀，發酵過度則花香不清。真正好的包種茶，是用製程引出自然花香，而不是用厚重焙火去遮蓋。",
        "文山包種茶的產地以北部文山茶區為核心，尤其新北坪林、石碇、深坑、新店、雙溪等地。歷史上，包種茶曾與窨花工藝有關，早期若茶香不足，會以茉莉、桂花等花材窨製增加香氣。後來經過王水錦、魏靜時等前輩推動與改良，逐漸發展出不靠加花、而能自然呈現花香的清香型包種茶。",
        "擇器與泡法上，建議用白瓷蓋碗或瓷壺，因為白瓷不吸香，最能表現包種茶的清雅香氣。水溫約 85 到 90 度，若茶葉品質成熟、製程到位，也可以接近 90 度沖泡。條形茶較蓬鬆，置茶量可約容器四分之一到三分之一。第一泡約 45 到 60 秒，出湯後不要長時間悶蓋，避免熱氣反覆蒸悶，影響細緻花香。文山包種可以這樣總結：它是北台灣山林裡最清雅的一縷花香。"
    ],
    3: [
        "台灣高山茶，是台灣烏龍茶最具國際辨識度的代表之一。一般所說的高山茶，多指海拔約一千公尺以上茶區製成的清香型球形烏龍。外觀通常為半球形或球形，茶乾緊結、色澤翠綠，茶湯以蜜黃色為代表，重點在清香、甘甜、滑順與山韻。",
        "高山茶的風味可以用清、香、甘、活來理解。香氣常帶花香、甜香與高山冷冽感，入口柔滑，茶湯乾淨，苦澀感較低，回甘明顯。好的高山茶不只是香，而是茶湯有厚度、有喉韻，喝完後口腔會留下清涼、甘甜、舒展的感覺。",
        "這種特色與高海拔環境密切相關。高山氣候冷涼，茶樹生長速度較慢，芽葉成熟期拉長；白天光合作用累積養分，夜晚低溫讓消耗減少，因此茶葉較容易累積甘甜物質與細緻香氣。再加上輕發酵、輕焙火的製作方向，能保留茶葉本身的山林氣息。",
        "高山茶不是單一產地，而是台灣多個高海拔茶區共同形成的風格。代表茶區包括阿里山、杉林溪、梨山、奇萊、翠峰、大禹嶺、特富野等。不同茶區因海拔、雲霧、日照、土壤與管理方式不同，會形成不同山頭氣，這也是台灣高山茶迷人的地方。",
        "擇器與泡法上，若要表現清香，適合白瓷蓋碗；若想增加茶湯厚度，可用朱泥壺或保溫性較好的陶壺。水溫建議 95 到 100 度，球形茶可快速溫潤泡，幫助茶葉舒展。注水可以採環狀注水，使球形茶均勻受水，茶湯更平衡。高山茶可以這樣總結：它喝的是台灣山林的冷涼、甘甜與清透。"
    ],
    4: [
        "凍頂烏龍茶，是台灣焙香型球形烏龍的經典代表。它的外觀通常為半球形或球形，顆粒緊結圓整，茶湯以金黃色為典型。與清香型高山茶相比，凍頂烏龍更重視發酵與焙火後形成的熟香、厚度與喉韻。",
        "品飲凍頂烏龍，香氣常見焙米香、焦糖香、熟果香、堅果香，有時也會有花香與火香交融的表現。茶湯入口圓潤、飽滿，滋味比清香烏龍更沉穩，回甘與喉韻明顯。好的凍頂烏龍不是單純的焦香，而是火候乾淨、甜韻深、茶湯厚。",
        "它的特色來自中度發酵與中度焙火。發酵提供茶湯的骨架與成熟香氣，焙火則修飾青味、提升香氣深度與口感厚度。烘焙過程中，茶葉中的游離胺基酸與還原糖在高溫與時間作用下，會產生類似梅納反應的香氣轉化，使茶湯出現焦糖、焙米、熟果等層次。",
        "凍頂烏龍的代表產區是南投鹿谷凍頂山一帶。台灣茶常以北包種、南凍頂來說明兩種經典風格：北部文山包種偏清香條形，南投凍頂烏龍偏焙香球形。凍頂烏龍之所以重要，是因為它建立了台灣傳統烏龍茶中發酵、團揉、焙火結合的典範。",
        "擇器與泡法上，適合使用紫砂壺、朱泥壺或陶壺，這類器具保溫性較好，能帶出焙火茶的厚度。水溫建議 95 到 100 度，可快速溫潤泡。注水可採單點注水，讓茶湯集中、香氣沉穩。第一泡約 50 到 70 秒，後續依茶湯濃度調整。凍頂烏龍可以這樣總結：它是一杯用火候養出的沉穩甘韻。"
    ],
    5: [
        "台灣鐵觀音，最具代表性的產地是台北木柵與貓空一帶，是台灣焙香型烏龍中非常有個性的茶。它的外觀多為半球形或球形，茶乾色澤較深，茶湯以琥珀色為典型。鐵觀音的特色不只是焙火香，而是焙火、果酸、收斂與回甘交織而成的觀音韻。",
        "品飲鐵觀音時，香氣常見熟果香、焙火香、木質調，甚至帶有微弱果酸或類似鐵鏽感的深沉氣息。入口時茶湯較有力度，收斂感明顯，但收斂之後會轉為回甘。它的層次比較深，不是清香型茶那種清揚，而是沉穩、有骨、有韻。",
        "鐵觀音與凍頂烏龍都可能有焙火香，但鐵觀音的重要差異在於傳統包布焙、包布揉。反覆包布、加熱、焙揉的過程，會減緩乾燥速度，讓茶菁在高溫濕熱中產生更深層的轉化，因此形成鐵觀音特有的微酸、厚韻與觀音韻。",
        "木柵鐵觀音常提到正欉鐵觀音品種，也就是紅心歪尾桃。這個品種生長較慢，葉質厚，茶骨強，適合做成中發酵、重焙火的風格。台灣鐵觀音可說是安溪鐵觀音工藝在台灣風土中的在地化發展，既保留傳統，又形成木柵獨有的茶韻。",
        "擇器與泡法上，鐵觀音適合紫砂壺、朱泥壺或陶壺，因為它需要高溫與保溫來打開香氣和韻味。水溫建議 95 到 100 度，茶形緊結，可先快速溫潤泡約 10 秒。第一泡約 50 到 70 秒，後續視茶湯濃度調整。鐵觀音可以這樣總結：它不是一入口就明亮外放的茶，而是越喝越深、越回越有韻的茶。"
    ],
    6: [
        "東方美人茶，又稱白毫烏龍、椪風茶，是台灣極具故事性的特色茶。它屬於重發酵的部分發酵茶，外觀常呈現白、綠、黃、紅、褐五色相間，因此也常被稱為五色茶。茶湯以橙黃到橙紅色為代表，最鮮明的特色是蜜香、熟果香與甜潤感。",
        "品飲東方美人時，香氣常帶天然蜂蜜、熟果、花香，有時像荔枝、蜜桃或龍眼蜜。茶湯入口甜和、圓潤，苦澀感低，水色明亮清澈。它不像清香烏龍那樣追求高揚花香，也不像焙火茶追求火候厚度，而是以天然蜜甜與優雅熟香取勝。",
        "這種特色主要來自小綠葉蟬著涎。茶芽被小綠葉蟬吸吮後，茶樹會產生防禦性化學反應，進而形成特殊蜜香前驅物。製茶時再透過重萎凋、重發酵與細緻揉捻，把蜜香與熟果香表現出來。也就是說，東方美人是昆蟲、茶樹、氣候與製茶師共同完成的作品。",
        "東方美人的代表產區在新竹北埔、峨眉，以及苗栗頭份、三灣等桃竹苗茶區，常用青心大冇等品種製作。由於必須等待小綠葉蟬著涎，產量有限，採摘與製程也更講究。傳說中的椪風茶之名，也帶有早期茶農因高價售茶而被說成膨風的故事色彩。",
        "擇器與泡法上，建議使用白瓷蓋碗、白瓷杯或玻璃壺，這樣能清楚觀察橙黃至橙紅的湯色，也不會吸附蜜香。水溫約 80 到 85 度，芽葉較細嫩，不建議溫潤泡。第一泡約 50 到 70 秒，注水宜柔和，避免把細嫩芽葉沖得過澀。東方美人可以這樣總結：它是台灣茶裡把蟲咬化為蜜香的優雅奇蹟。"
    ],
    7: [
        "紅烏龍茶，是台灣近代發展出的創新型特色茶，代表產地是台東鹿野。它兼具紅茶的紅湯甜香、烏龍茶的球形外觀與焙火後的厚度，因此常被形容為三合一風格。外觀多為緊結球形，色澤偏墨紅或烏黑油潤，茶湯明亮，呈橙紅到紅艷色。",
        "紅烏龍的風味相當鮮明，香氣常有熟果香、焦糖香、焙火香，也帶有紅茶般的甜韻。入口醇厚、飽滿，茶湯有甜感與果膠質，冷泡時甜潤感尤其明顯。它不像傳統清香烏龍那麼清揚，而是更成熟、更濃郁，也更容易被一般消費者接受。",
        "它的特色來自複合製程。製作時會採取較重的萎凋與發酵，使茶湯接近紅茶般的橙紅色與熟果甜香；同時又保留烏龍茶的殺菁、揉捻與球形外觀；後續再以中度溫慢焙火增加焙火香、焦糖感與厚度。因此紅烏龍不是單純紅茶，也不是傳統烏龍，而是台灣茶工藝的創新成果。",
        "台東鹿野因氣候、日照與茶區發展需求，逐漸形成紅烏龍這種具有高辨識度的茶款。它在熱泡、冷泡、瓶裝與年輕市場推廣上都有優勢，也讓台灣特色茶從傳統工藝走向更現代的應用場景。",
        "擇器與泡法上，熱泡可使用白瓷壺、瓷蓋碗觀察湯色，也可用紫砂或陶壺增加厚度。水溫約 90 到 95 度，可快速溫潤泡。第一泡約 45 到 60 秒。冷泡則可用常溫水或冷水，放入冰箱 6 到 8 小時，能呈現更明顯的果香與甜潤。紅烏龍可以這樣總結：它是一杯把紅茶甜、烏龍韻與焙火厚度融合起來的台東創新茶。"
    ],
    8: [
        "台灣紅茶屬於全發酵茶，是台灣特色茶中非常重要的一類。紅茶的外觀色澤多偏黑或烏潤，茶湯以紅色為代表。台灣紅茶可以分成大葉種紅茶與小葉種紅茶兩條路線：大葉種強調厚度與品種香，小葉種則常呈現蜜香、熟果香與柔順甜感。",
        "以日月潭紅玉為例，香氣常有肉桂、薄荷與熟果調，茶湯紅艷明亮，入口滋味較強勁、飽滿，有明顯骨架。若是小葉種紅茶，例如蜜香紅茶或小葉種製成的紅茶，則常帶蜂蜜、熟果、甜香，口感相對柔和，回甘細緻。",
        "紅茶的特色來自完全氧化。茶菁採摘後先萎凋，使水分下降、葉片柔軟，再透過揉捻破壞細胞組織，讓茶汁與氧氣充分接觸，茶多酚氧化形成紅茶特有的紅湯、甜香與醇厚口感。大葉種內含物較豐富，所以滋味強；小葉種茶質細緻，則容易表現甜香與柔順。",
        "台灣紅茶的重要產區包括南投魚池、日月潭一帶，也包含花東與各地小葉種紅茶產區。日治時期台灣開始系統性發展紅茶，後來台茶 18 號紅玉、台茶 21 號紅韻等品種，使台灣紅茶建立出非常明確的品種特色與市場辨識度。",
        "擇器與泡法上，建議使用白瓷蓋碗、瓷壺或玻璃壺，方便觀察紅亮湯色，也能保留香氣的乾淨度。水溫通常約 90 到 95 度；若茶芽細嫩，可降到 85 到 90 度。紅茶通常不需要溫潤泡，第一泡約 40 到 60 秒。若想做西式紅茶或加奶，可提高茶量與浸泡時間。台灣紅茶可以這樣總結：它用紅亮茶湯與鮮明品種香，讓世界從一杯茶記住台灣。"
    ]
};const ESSAY_DATA = [
    {
        id: 1,
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-6 animate-in slide-in-from-bottom-4 duration-500 pb-16">
            <div className="text-center space-y-3 mb-10 mt-4">
                ...
                <p className="text-stone-600 font-medium text-lg">每款特色茶整理為 2–3 分鐘的專業講師介紹：先掌握色、香、味與口感，再說明特色成因、產地製程，最後提供擇器與沖泡建議。</p>
            </div>
