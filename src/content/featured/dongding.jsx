    ...
    return (
        <div className="animate-fadeIn">
            ...
            <div ref={contentRef} className="space-y-16">
                ...
                />
                <div className="mb-8 rounded-2xl overflow-hidden shadow-2xl border border-stone-100">
                    <DongDingLeafGraphic />
                </div>
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="bg-gradient-to-r from-stone-800 to-stone-700 text-stone-100 p-8 md:p-12 rounded-xl shadow-lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-10">
                                ...
                                <div className="bg-stone-900/50 p-6 rounded-lg border-l-4 border-amber-500">
                                    <h4 className="text-amber-400 font-bold text-lg mb-3">古法工藝的堅持</h4>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid md:grid-cols-3 gap-6 text-center">
                                    <div className="bg-white p-4 rounded shadow-sm">
                                        ...
                                        <div className="text-xs text-stone-500">全盛時期 (1,700公頃)</div>
                                    </div>
                                    <div className="flex flex-col justify-center items-center">
                                        <div className="w-full h-1 bg-stone-300 rounded relative">
                                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-stone-100 px-2 text-xs font-bold text-red-600">
                                                921 大地震
                                            </div>
                                        </div>
                                    </div>
                                    <div className="bg-white p-4 rounded shadow-sm">
                                        ...
                                        <div className="text-xs text-stone-500">轉型期 (~1,000公頃)</div>
                                    </div>
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-8 text-stone-700 leading-relaxed">
                                    <div>
                                        <h5 className="font-bold text-lg text-stone-900 mb-3">蜜香貴妃的誕生</h5>
                                        <p className="text-sm">
                                            921地震後茶園一度荒廢，鹿谷農會帶領青年茶農，利用被<strong>小綠葉蟬</strong>吸食過的茶菁，製作成帶有蜜香的「貴妃茶」，將危機化為轉機，開創了鹿谷新產品。
                                        </p>
                                    </div>
                                    <div>
                                        <h5 className="font-bold text-lg text-stone-900 mb-3">機械化的反思</h5>
                                        <p className="text-sm">
                        ...
                        <div className="bg-stone-100 p-8 md:p-12 rounded-xl border-l-8 border-amber-700 shadow-lg mb-12 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center mb-6">
                                    <span className="bg-stone-800 text-white px-3 py-1 text-xs font-bold rounded uppercase tracking-wider mr-3">Expert Seminar</span>
                                ...
                                <div className="space-y-12">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="prose prose-stone">
                                            ...
                                            <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-stone-400 mt-4 text-sm text-stone-600">
                                                <p>
                                        ...
                                        <div className="bg-stone-200/50 p-6 rounded-xl">
                                            ...
                                            <ul className="space-y-3">
                                                <li className="flex items-center justify-between p-2 bg-white rounded shadow-sm">
                                                    ...
                                                    <span className="text-xs text-stone-500">頂級產區 (海拔 ~750m)</span>
                                                </li>
                                                <li className="flex items-center justify-between p-2 bg-white/80 rounded shadow-sm">
                                                    ...
                                                    <span className="text-xs text-stone-500">麒麟潭周邊 (~500m)</span>
                                                </li>
                                                <li className="flex items-center justify-between p-2 bg-white/60 rounded shadow-sm">
                                                    ...
                                                    <span className="text-xs text-stone-500">平地茶園 (~200-300m)</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-amber-50 rounded-xl p-8 border border-amber-200">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 text-center mb-6">
                                            <div className="p-4">
                                                <div className="text-stone-500 text-xs mb-1">當年參賽件數</div>
                                                <div className="text-3xl font-bold text-amber-800">104 <span className="text-sm text-stone-500">件</span></div>
                                                <div className="text-xs text-stone-400 mt-1">今日已達 4,477+ 件</div>
                                            </div>
                                            <div className="p-4 border-x border-amber-200">
                                                <div className="text-stone-500 text-xs mb-1">當年平均茶價</div>
                                                <div className="text-3xl font-bold text-amber-800">300 <span className="text-sm text-stone-500">元/斤</span></div>
                                                <div className="text-xs text-stone-400 mt-1">當時「茶米同價」</div>
                                            </div>
                                            <div className="p-4">
                                                <div className="text-stone-500 text-xs mb-1">特等獎天價</div>
                                                <div className="text-3xl font-bold text-red-700">5,000 <span className="text-sm text-stone-500">元/斤</span></div>
                                                <div className="text-xs text-stone-400 mt-1">開啟了比賽茶的黃金時代</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                            {[
                                                ...
                                                <div key={i} className="bg-white p-4 rounded-lg shadow-sm border-t-4 border-amber-600 text-center hover:-translate-y-1 transition-transform duration-300">
                                                    ...
                                                    <div className="text-xs text-stone-600 leading-snug">{item.desc}</div>
                                                </div>
                                            ))}
                                        </div>
                                        <div className="mt-6 text-center text-sm text-stone-500 bg-stone-100 p-3 rounded-full inline-block">
                        ...
                        <div className="bg-white p-8 md:p-12 rounded-xl shadow-sm border border-stone-200">
                            <div className="text-center mb-12">
                                <span className="inline-block px-3 py-1 bg-amber-100 text-amber-800 text-xs font-bold rounded-full mb-3">Expert Guide</span>
                            ...
                            <div className="bg-gradient-to-r from-stone-800 to-stone-900 text-stone-200 p-6 rounded-xl mb-12 shadow text-center">
                                <h4 className="text-amber-400 font-bold mb-4 flex items-center justify-center text-lg">
                                    <Search className="mr-2" size={20} /> 行家看門道：你不知道的潛規則
                                </h4>
                                <div className="grid md:grid-cols-3 gap-6 text-sm">
                                    <div className="bg-white/10 p-4 rounded backdrop-blur-sm">
                                        <strong className="block text-white text-base mb-1">頭等10 = 第11名</strong>
                                        <span className="text-stone-300">特等(1) &gt; 頭等1...頭等10 (11)</span>
                                    </div>
                                    <div className="bg-white/10 p-4 rounded backdrop-blur-sm">
                                        <strong className="block text-white text-base mb-1">價格的天花板</strong>
                                        <span className="text-stone-300">特等獎報價 30萬 (新聞價)<br />實際成交約 24萬 (8折)</span>
                                    </div>
                                    <div className="bg-white/10 p-4 rounded backdrop-blur-sm">
                                        <strong className="block text-white text-base mb-1">名人堂榮耀</strong>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="bg-stone-50 p-8 rounded-xl border border-stone-200">
                                    ...
                                    <div className="space-y-6 text-stone-700 leading-relaxed">
                                        <div>
                                            ...
                                            <p className="mt-2 text-sm bg-white p-4 rounded border border-stone-200">
                                ...
                                <div className="bg-white p-8 rounded-xl border-2 border-stone-100">
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="flex flex-wrap justify-center gap-4 text-sm font-bold text-stone-700">
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        ...
                                        <div className="bg-stone-50 p-6 rounded-xl">
                                            <h5 className="text-lg font-bold text-stone-900 mb-4 border-b border-stone-300 pb-2">鹿谷茶區</h5>
                                            <div className="space-y-6 text-sm text-stone-700">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-stone-500 mt-1">註：入等名額約為參加總人數之16%。</p>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    金牌獎 &gt; 銀牌獎 &gt; 銅牌獎 &gt; 優良獎
                                                    <p className="text-xs text-red-500 mt-1 font-bold">※ 全台目前僅鹿谷合作社舉辦貴妃茶比賽，量少珍貴。</p>
                                                </div>
                                                <div>
                                        ...
                                        {/* High Mountain */}
                                        <div className="bg-stone-50 p-6 rounded-xl">
                                            <h5 className="text-lg font-bold text-stone-900 mb-4 border-b border-stone-300 pb-2">高山比賽茶區</h5>
                                            <div className="space-y-6 text-sm text-stone-700">
                                                <div>
                                        ...
                                        {/* Oriental Beauty */}
                                        <div className="bg-stone-50 p-6 rounded-xl">
                                            <h5 className="text-lg font-bold text-stone-900 mb-4 border-b border-stone-300 pb-2">東方美人茶區</h5>
                                            <div className="space-y-6 text-sm text-stone-700">
                                                <div>
                                        ...
                                        {/* Sun Moon Lake */}
                                        <div className="bg-stone-50 p-6 rounded-xl">
                                            <h5 className="text-lg font-bold text-stone-900 mb-4 border-b border-stone-300 pb-2">日月潭紅茶比賽茶區</h5>
                                            <div className="space-y-4 text-sm text-stone-700">
                                                <p className="text-xs text-stone-500 mb-2">主辦單位：魚池鄉農會 (以參與件數決定排名)</p>
                                                {[
                                                    '大葉種 (大葉阿薩姆) 組',
                                                    '山茶 (台灣原生山茶) 組',
                                                    '紅玉 (台茶18號) 組',
                        ...
                        <div className="bg-stone-900 text-amber-50 p-8 md:p-16 rounded-2xl shadow-2xl border border-stone-800 relative overflow-hidden">
                            ...
                            <div className="text-center mb-16 relative z-10">
                                <span className="inline-block px-4 py-1.5 bg-amber-900/50 border border-amber-700/50 text-amber-200 text-sm tracking-widest font-bold rounded-full mb-6">
                                    大師專欄
                                </span>
                            ...
                            <div className="space-y-20 relative z-10">
                                ...
                                <div className="prose prose-invert max-w-none">
                                    ...
                                    <div className="text-stone-300 leading-loose space-y-6 text-lg">
                                        <p>
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        <div className="bg-gradient-to-br from-stone-800 to-stone-900 p-6 rounded-xl border border-stone-700 group hover:border-amber-600 transition-colors">
                                            ...
                                            <h5 className="text-lg font-bold text-amber-100 mb-3">重萎凋．輕攪拌</h5>
                                        ...
                                        <div className="bg-gradient-to-br from-stone-800 to-stone-900 p-6 rounded-xl border border-stone-700 group hover:border-amber-600 transition-colors">
                                            ...
                                            <h5 className="text-lg font-bold text-amber-100 mb-3">低溫長炒</h5>
                                            <p className="text-stone-400 text-sm leading-relaxed">
                                                降低釜炒機溫度、拉長炒菁時間。
                                        ...
                                        <div className="bg-gradient-to-br from-stone-800 to-stone-900 p-6 rounded-xl border border-stone-700 group hover:border-amber-600 transition-colors">
                                            ...
                                            <h5 className="text-lg font-bold text-amber-100 mb-3">外觀：半球型</h5>
                                            <p className="text-stone-400 text-sm leading-relaxed">
                                        ...
                                        <div className="bg-gradient-to-br from-stone-800 to-stone-900 p-6 rounded-xl border border-stone-700 group hover:border-amber-600 transition-colors">
                                            ...
                                            <h5 className="text-lg font-bold text-amber-100 mb-3">亮麗橙黃</h5>
                                            <p className="text-stone-400 text-sm leading-relaxed">
                                                紅水烏龍並非「積水紅」（湯色深紅）。
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-amber-50 p-8 rounded-xl border border-green-100 mb-12">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-sm border-t-4 border-amber-600">
                                    <h5 className="font-bold text-lg text-amber-800 mb-3 text-center">傳統凍頂/焙火茶 (有轉發酵)</h5>
                                    <ul className="space-y-2 text-sm text-stone-600">
