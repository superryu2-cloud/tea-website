      ...
      <div ref={contentRef} className="space-y-16 max-w-5xl mx-auto px-4 md:px-0">
        ...
        <section className="grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            ...
            >
              ...
              <p className="absolute bottom-3 left-4 text-white text-xs font-bold tracking-wider">纖手採摘</p>
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-60"></div>
              <p className="absolute bottom-4 left-6 text-white text-sm font-bold tracking-wider">驚蟄・春雷動</p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-12 max-w-2xl text-white space-y-6 pointer-events-none">
            ...
            <p className="text-lg md:text-xl text-emerald-50 opacity-95 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                ...
                <p className="text-stone-600 text-sm">相傳一位名為「碧螺」的姑娘，為救治愛人上山採藥，不幸墜崖。她身殞之處長出了一棵茶樹，人們認為是她的化身，遂以「碧螺」為其命名。</p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                <h4 className="font-bold text-emerald-800 mb-2">地名來源</h4>
                <p className="text-stone-600 text-sm">此茶原產於江蘇洞庭湖東西兩山的碧螺峰，因地得名。</p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                <h4 className="font-bold text-emerald-800 mb-2">外形特徵</h4>
                <p className="text-stone-600 text-sm">最為直觀的解釋，綜合了茶葉「色澤碧綠、形態捲曲如螺、於春天採摘」的三大特點，故名「碧螺春」。</p>
              </div>
            </div>
        ...
        <section className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="absolute bottom-6 right-6 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full text-xs font-bold text-emerald-800 shadow-sm">
              上投法・雪片紛飛
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div>
              ...
              <div className="bg-emerald-50 border-l-4 border-emerald-400 p-4 text-emerald-900 text-sm">
                此時會出現一個極美的景象——滿佈的白毫在接觸水分後，會增加茶芽的重量，使其「如雪片般」紛紛揚揚地飄落至碗底，整個過程充滿了動態的詩意。
              </div>
            </div>

            <div>
              <h4 className="text-lg font-bold text-stone-900 mb-2">品飲樂趣：嚼茶</h4>
              <p className="text-stone-700 leading-relaxed">
        ...
        <section className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4 text-stone-700">
              ...
              <ul className="space-y-4 mt-4">
                <li className="flex gap-4 p-4 bg-emerald-50/50 rounded-xl border border-emerald-100">
                  ...
                  <span className="text-sm">春天屬木，對應肝臟。飲用綠茶（如碧螺春）性微寒，助疏肝理氣，清解春燥。</span>
                </li>
                <li className="flex gap-4 p-4 bg-stone-100/50 rounded-xl border border-stone-200">
                  ...
                  <span className="text-sm">冬天屬水，對應腎臟。飲用普洱熟茶，性溫和，湯色深濃，助溫養腎氣。</span>
                </li>
              </ul>
          ...
          <div className="bg-gradient-to-br from-stone-50 to-white rounded-3xl border border-stone-200 overflow-hidden shadow-sm h-full flex flex-col">
            ...
            >
              ...
              <div className="absolute bottom-4 left-6 text-white font-bold text-lg drop-shadow-md">茶果間植的智慧</div>
            </div>
            <div className="p-8 flex-1">
              <p className="text-stone-700 leading-relaxed mb-4">
                碧螺春獨特的「花香果味」，源於古代茶園管理智慧——<strong>「花果樹交錯間栽」</strong>。古人認為茶樹根系會與周邊花果樹（如桃、李、杏、梅）在土壤中盤錯，吸收其獨特香氣。
              </p>
              <div className="text-sm text-stone-500 bg-stone-100 p-4 rounded-xl">
