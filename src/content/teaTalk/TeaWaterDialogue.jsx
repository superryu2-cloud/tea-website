...
export default function TeaWaterDialogue() {
  return (
    <div className="space-y-8">
      ...
      <SectionCard title="一、茶樹生育期的水分生理機制" icon={Droplets}>
        <div className="space-y-5">
          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <SubTitle id="tt-water-1-1">根系分工</SubTitle>
            <Bullets>
              <Bullet>主根：固定植株。</Bullet>
              <Bullet>側根：儲存養分。</Bullet>
              <Bullet>鬚根：水分與養分吸收主力。[1][2][3]</Bullet>
            </Bullets>
          </div>

          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <SubTitle id="tt-water-1-2">水在茶樹體內的角色</SubTitle>
            <Bullets>
              <Bullet>光合作用原料：與二氧化碳共同合成養分。[4]</Bullet>
              <Bullet>代謝與傳輸：養分透過木質部運輸需要水分帶動；缺水代謝容易失序。[4]</Bullet>
              <Bullet>環境緩衝：水的比熱與緩衝性可減少高低溫劇變傷害。[4]</Bullet>
            </Bullets>
          </div>
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody className="divide-y divide-stone-200 text-stone-800">
                <tr>
                  ...
                  <td className="px-5 py-4">室內萎凋，失水約 60%～70%。[7][5]</td>
                ...
                <tr>
                  ...
                  <td className="px-5 py-4">室外約 30–35°C；一般日光萎凋失水約 5%～10%；東方美人可達 25%～35%。[7]</td>
                  <td className="px-5 py-4">攪拌：促進均勻失水、提高酵素活性，推進發酵。[8]</td>
                </tr>
                <tr>
                  <td className="px-5 py-4 font-bold">紅茶</td>
                  <td className="px-5 py-4">室內萎凋後重揉捻</td>
                  <td className="px-5 py-4">室內萎凋約 16–20 小時；失水率約 30%～50（春 50、夏 40、秋 30）。[8]</td>
                  <td className="px-5 py-4">補足發酵需高濕（相對濕度約 90%）；揉捻應避免起泡或滴水。[5]</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <SectionCard title="三、儲藏的含水量控制：3–5% 是關鍵" icon={Sparkles}>
        <div className="rounded-2xl border border-stone-200 bg-white overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead className="bg-stone-50 text-stone-700">
              <tr className="text-left">
      ...
      <SectionCard title="四、沖泡科學：水質與水溫如何改變色香味" icon={Thermometer}>
        <div className="space-y-5">
          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <SubTitle id="tt-water-4-1">1) 水質（pH 與硬度）</SubTitle>
            <Bullets>
              <Bullet>
                pH：較適合泡茶的水質常以微酸性（約 pH 6.5–6.8）描述；中性/微鹼性水可能使茶湯後氧化、水色暗濁、鮮活性下降。[11][12]
              </Bullet>
              <Bullet>
                硬度：主要是鈣、鎂等礦物質；金屬離子可與兒茶素形成絡合物，使茶湯暗濁。礦物質越少（如純水），保留的兒茶素越多。[9][13]
              </Bullet>
              <Bullet>咖啡因與氨基酸的溶出量，通常不受礦物質多寡影響。[14]</Bullet>
            </Bullets>
          </div>

          <div className="rounded-2xl border border-stone-200 bg-white p-5">
            <SubTitle id="tt-water-4-2">2) 水溫（熱泡 vs 冷泡）</SubTitle>
            <Bullets>
              <Bullet>高溫（熱泡）：更容易萃取酯型兒茶素（收斂性）與咖啡因（苦味），水色也更深。[14][15]</Bullet>
              <Bullet>低溫（冷泡）：氨基酸（甘味）相對更容易溶出，兒茶素與咖啡因較少，風味常呈「多甘甜、少苦澀」。[15][16]</Bullet>
              <Bullet>綠茶兒茶素含量高，若高溫久浸易苦澀，因此常更適合較低溫沖泡以突顯甘味。[16]</Bullet>
              <Bullet>高山氣壓較低，約 95°C 即沸騰，與平地 100°C 不同，亦可能帶來沖泡風味差異。[17]</Bullet>
            </Bullets>
          </div>
