...
export default function ChonghuaChapter05() {
    const TOC = [
        ...
        { id: 'ch05-trigger', label: '氧化怎麼開始？' },
        { id: 'ch05-enzymes', label: '兩種酶的分工' },
        { id: 'ch05-color', label: '顏色的秘密' },
        { id: 'ch05-temp', label: '溫度的影響' },
        { id: 'ch05-stop', label: '如何停止氧化？' },
    ...
    return (
        <div className="flex gap-8">
            ...
            <div className="flex-1 min-w-0 space-y-12">
                ...
                >
                    {/* ═══════════ 1. 課程簡介 ═══════════ */}
                    <AcademyContentBlock title="課程簡介" icon={BookOpen} id="ch05-intro">
                        {/* Hero Banner */}
                    ...
                    {/* ═══════════ 2. 什麼是氧化？ ═══════════ */}
                    <AcademyContentBlock title="什麼是氧化？" icon={Leaf} id="ch05-what">
                    ...
                    {/* ═══════════ 3. 氧化 vs. 發酵 ═══════════ */}
                    <AcademyContentBlock title="先搞清楚：氧化 ≠ 發酵" icon={FlaskConical} id="ch05-vs">
                    ...
                    {/* ═══════════ 4. 氧化怎麼開始？ ═══════════ */}
                    <AcademyContentBlock title="氧化是怎麼開始的？" icon={Wind} id="ch05-trigger">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                            <p className="text-[17px] text-stone-700 leading-relaxed">
                    ...
                    {/* ═══════════ 4.5 兩種酶的分工 ═══════════ */}
                    <AcademyContentBlock title="幕後的兩位工人：PPO 和 POD" icon={Users} id="ch05-enzymes">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                            <p className="text-[17px] text-stone-700 leading-relaxed">
                    ...
                    {/* ═══════════ 5. 顏色的秘密 ═══════════ */}
                    <AcademyContentBlock title="顏色的秘密：兒茶素的變身之旅" icon={Droplets} id="ch05-color">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                            <p className="text-[17px] text-stone-700 leading-relaxed">
                    ...
                    {/* ═══════════ 6. 如何停止氧化？ ═══════════ */}
                    <AcademyContentBlock title="剎車！怎麼停止氧化？" icon={Flame} id="ch05-stop">
                        {/* 殺青圖 */}
                        <div className="mb-8 rounded-2xl overflow-hidden shadow-md border border-stone-100 bg-stone-50 p-2">
                            <ImageLightbox
                    ...
                    {/* ═══════════ 6.5 溫度的影響 ═══════════ */}
                    <AcademyContentBlock title="溫度：氧化的油門與剎車" icon={Thermometer} id="ch05-temp">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                            <p className="text-[17px] text-stone-700 leading-relaxed">
                    ...
                    {/* ═══════════ 7.5 進階思考 ═══════════ */}
                    <AcademyContentBlock title="進階思考：同樣是製茶，思路大不同" icon={Eye} id="ch05-practice">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                            <p className="text-[17px] text-stone-700 leading-relaxed">
                    ...
                    {/* ═══════════ 8. 六大茶類光譜 ═══════════ */}
                    <AcademyContentBlock title="六大茶類的氧化光譜" icon={Layers} id="ch05-six">
                        {/* 六大茶類光譜圖 */}
                        <div className="mb-8 rounded-2xl overflow-hidden shadow-md border border-stone-100 bg-stone-50 p-2">
                            <ImageLightbox
                    ...
                    {/* ═══════════ 8. 帶走的觀念 ═══════════ */}
                    <AcademyContentBlock title="今天帶走的三個觀念" icon={Coffee} id="ch05-summary">
