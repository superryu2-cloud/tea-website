...
const TeaWebsite = () => {
  ...
  const TeaChemistryDeepDive = ({ embedded = false }) => {
    ...
    return (
        <div className={embedded ? "font-serif" : "py-12 font-serif animate-fadeIn"}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {!embedded && (
                <div className="mb-10">
                  <div className="museum-frame museum-paper relative overflow-hidden">
        ...
        <div className="mb-12">
          <div className="museum-frame museum-paper overflow-hidden">
            <div className="px-6 py-5 md:px-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <button
                type="button"
                onClick={() => setShowCultivarDiversity((v) => !v)}
                aria-expanded={showCultivarDiversity}
                className="inline-flex items-center justify-center px-5 py-2.5 rounded-xl text-sm font-extrabold border transition-colors self-start md:self-auto w-full md:w-auto
                  border-stone-300 text-stone-900 bg-white/70 hover:bg-white"
              >
                {showCultivarDiversity ? '收合內容' : '展開內容'}
              </button>
            </div>
